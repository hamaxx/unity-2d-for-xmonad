        ...
        */
        ...
        Loader {
            ...
            */
            ...
            anchors.right: leftRight(!filterPane.visible || filterPane.folded ? parent.right : filterPane.left,
                parent.right)
            anchors.rightMargin: leftRight(!filterPane.visible || filterPane.folded ? 0 : 15,
                0)
