...
class ExcludeSortFilterProxyModelTest : public QObject
{
    Q_OBJECT
...
private Q_SLOTS:
    ...
    {
        ExcludeSortFilterProxyModelQML proxy;
        MockListModel model;
    ...
    void testExclude() {
        ...
        // Check that without a filterRegExp all rows are accepted
...
QTEST_MAIN(ExcludeSortFilterProxyModelTest)

#include "excludesortfilterproxymodeltest.moc"
